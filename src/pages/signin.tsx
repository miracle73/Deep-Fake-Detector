...
function Signin() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* Right side - Logo and branding (desktop only) */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-50 to-indigo-100 flex-col justify-between items-center p-8 min-h-screen">
